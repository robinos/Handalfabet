...
public class SoundSettings extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATEe = "CREATE TABLE "+ SOUND_TABLE +   
			                    "(" + colName + " VARCHAR(36) PRIMARY KEY,"+ 
		                        colVolume + " INTEGER, " + 
		                        colSound + " INTEGER, " +
		                        colVibrations + " INTEGER)";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		// TODO Auto-generated method stub
		Log.w(SoundSettings.class.getName(),
    ...
    public int updateEntry(User user) {
        ...
        // updating row
        return db.update(SOUND_TABLE, values, colName + " =?",  new String[]{ String.valueOf(name) });
    }
