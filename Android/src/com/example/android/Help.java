...
/**
 * The Help class is the help menu activity, allowing access to Alphabet Help
 * Activity or Game Help Activity through two buttons.
 * 
 * @author : Grupp02
...
public class Help extends Activity {
	...
	gameHelpButton.setOnClickListener(new View.OnClickListener() {
		...
		startActivity(new Intent(
			"android.intent.action.GAMEHELPACTIVITY")
	...
	alphabetHelpButton.setOnClickListener(new View.OnClickListener() {
		...
		playButton();
		startActivity(new Intent(
			"android.intent.action.ALPHABETHELPACTIVITY")
			.putExtra("Name", userName.getText().toString())
			.putExtra("userImg", img)
			.putExtra("User", userStatus.getText()));
	    }
    ...
    /**
     * Handle pausing sound. We don't abandon focus here yet. The listener will
     * hopefully do that for us.
     */
    @Override
    public void onPause() {
